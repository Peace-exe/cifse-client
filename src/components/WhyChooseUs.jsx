          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">Excellence in Fire and Safety Education</h2>
              ...
              <Card className="text-center border-gray-300 shadow-xl">
                ...
                <CardContent>
                  <p className="text-sm text-gray-600">
                    State-of-the-art laboratories, simulation centers, and modern classrooms equipped with latest
                    technology.
                  </p>
                </CardContent>
              </Card>
