          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none">Comprehensive Fire & Safety Courses</h2>
                <p className="max-w-[900px] text-gray-600 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Choose from our range of specialized programs designed to meet industry demands and career
                  aspirations.
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-2">
              ...
              <Card className="relative overflow-hidden border-gray-300 shadow-xl">
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <Badge className="bg-red-600 hover:bg-red-700 rounded-full text-neutral-50">Degree Programs</Badge>
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button className="w-full bg-red-600 hover:bg-red-700 text-neutral-50">Learn More</Button>
                </CardContent>
              </Card>
              ...
              <Card className="relative overflow-hidden border-gray-300 shadow-xl">
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <Badge variant="secondary" className="bg-gray-100 rounded-full">Diploma Programs</Badge>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-center space-x-4 text-sm">
                    <div className="flex items-center">
                      <Clock className="mr-1 h-4 w-4" />6 months - 2 Years
                    </div>
                    <div className="flex items-center">
                      <BookOpen className="mr-1 h-4 w-4" />
                      Full/Part-time
