    ...
    <section id="about" className=" max-w-[90rem] mx-auto py-12 md:py-24 lg:py-32">
      <div className="container px-4 md:px-6">
        <div className="grid gap-6 lg:grid-cols-[400px_1fr] lg:gap-12 xl:grid-cols-[600px_1fr]">
          <img
            src="/placeholder.svg?height=400&width=600&text=Fire+Safety+Laboratory"
            width={600}
            height={400}
          ...
          <div className="flex flex-col justify-center space-y-4">
            <div className="space-y-2">
              ...
              <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none">
                Leading Fire Safety Education <span className="text-red-600">Since 1995</span>
              </h2>
              <p className="max-w-[600px] text-gray-600 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Central Institute of Fire and Safety Engineering has been at the forefront of fire and safety engineering education for over 25 years.
            ...
            <div className="grid gap-4 md:grid-cols-2 ">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm">COTTED Approved Courses</span>
              </div>
              <div className="flex items-center space-x-2">
                <CheckCircle className="h-5 w-5 text-red-600" />
